export const ProjectMediaTokens = {
  gallery: { className: 'project-gallery mt-24 flex items-start snap-x snap-mandatory gap-4 overflow-x-auto pb-4 [scrollbar-color:var(--blue)_var(--line)] max-[760px]:mt-16' },
  ...
  image: { className: 'block h-auto max-h-[42rem] w-full object-contain object-top' },
