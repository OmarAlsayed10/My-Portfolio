...
import { projectCategoryNames } from '../../projectCategories'
...
) : <div {...ProjectMediaTokens.fallback} data-category={project.categories[0]}><span>{projectCategoryNames(project.categories, language)}</span><i /><i /><i /></div>
